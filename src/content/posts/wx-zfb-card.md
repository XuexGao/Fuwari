...
---
> [!ai] qwen/qwen3-vl-8b
> 中国支付体系以二维码和微信/支付宝为主，非银联直连，需通过银行卡作为跨平台“兼容层”。支付宝与微信分属阿里与腾讯，无法直接互转资金，需经银行卡中转，但受限于发卡行政策（如网商银行、微众银行卡不被对方接受），中立银行（如交行、农行）更适配。银行卡有Ⅰ/Ⅱ/Ⅲ类之分，Ⅰ类日限额高但易被风控冻结，尤其大额快进快出触发反诈机制，需线下解冻。信用卡无日限额但无法直接提现，仍受储蓄卡限额约束，且部分商户（如学校食堂）不支持信用卡支付。巨头间“蓝绿争霸”持续，用户被迫依赖银行卡互转并承担冻结风险，微信与支付宝提现费低但高频使用下仍具可观收益，用户只能妥协。
