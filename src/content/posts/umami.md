...
1.  Umami Cloud 是一个自托管的平台，需要自行搭建。
2.  通过注册账号并填写相关信息，进行账户设置。
3.  检查邮箱验证，获取 Umami 的验证码登录。
4.  选择统计区域（美国或欧盟），并根据数据需求配置网站跟踪代码。
5.  将跟踪代码插入到网站的 `<head>` 部分。
6.  开启分享URL功能，方便用户实时查看网站流量。
:::
