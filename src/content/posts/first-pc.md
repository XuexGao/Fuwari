...
---
> [!ai] qwen/qwen3-vl-8b
> 因Mac使用体验不佳、笔记本频繁故障，作者决定放弃苹果生态，转而挑战DIY台式机。通过朋友赠送的Intel转AMD主板和CPU，作者自购显卡、内存、硬盘等配件，最终组装成功一台AMD平台主机。装机过程中遇到内存卡扣设计不符、水冷RGB接口不足、机箱螺丝柱无配套工具、说明书误导选错散热器等问题，均通过灵活调整解决。性能测试显示CPU-Z跑分达标、游戏帧率稳定、内存与缓存表现优秀、硬盘读写速度良好、功耗与温度控制合理，整体装机过程虽坑多但成果显著。
