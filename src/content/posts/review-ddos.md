...
---
> [!ai] qwen/qwen3-vl-8b
> 静态网站因无源站、依赖CDN，攻击者打CDN实为“白打”，但若攻击者目标非瘫痪CDN而是利用其资源，仍可发起大规模DDoS。2025年12月16日，本站遭6.65TB流量攻击，峰值1.95GB/s，初期误判为EdgeOne限频，后切换至Cloudflare缓解。随后因追求国内速度，又切回阿里云ESA，遭国内IP攻击持续四个月，攻击者利用未修复漏洞肉鸡发起流量刷爆，L7防护无效，最终迁移至Cloudflare稳定服务。静态网站虽难被彻底攻破，但CDN防护能力差异及L4层攻击仍可致服务中断，且可能触发平台封禁。WAF仅限L7，对L4层TCP连接无阻，需CDN底层防护才能真正防御。
