...
---
> [!ai] qwen/qwen3-vl-8b
> 域名邮箱可通过腾讯企业邮箱或网易免费企业邮实现，腾讯方案更优：配置简单、稳定性高、SMTP/IMAP支持直接，网易虽免费但需手动开启权限且体验较差。腾讯需绑定企业微信、添加MX记录，登录后在设置中获取服务器信息并生成客户端密码；网易需创建管理员账号、绑定域名并配置DNS记录，登录需用网易邮箱大师客户端，支持手机授权增强安全。
